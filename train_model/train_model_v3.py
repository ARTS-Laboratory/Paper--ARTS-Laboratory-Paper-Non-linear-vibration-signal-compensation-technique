...
"""
Still stateful, change datasets:
Training:
    0-1 Hz
    2-3 Hz
    3-4 Hz
...
X_train = np.append(X_train_full[:1], X_train_full[2:5], axis=0)
Y_train = np.append(Y_train_full[:1], Y_train_full[2:5], axis=0)

X_train = np.append(X_train, X_test_full[2:3], axis=0)
Y_train = np.append(Y_train, Y_test_full[2:3], axis=0)
